...
|編輯分類資料夾|更改資料夾名稱。|||
|刪除分類資料夾|將不必要的資料夾刪除，內部的書會移至未分類。|<video width="2000" controls><source src="https://github.com/Fallenleaf666/LeafNovel/blob/master/screenshot/deleteClassFolder.mp4" type="video/mp4"></video>||
